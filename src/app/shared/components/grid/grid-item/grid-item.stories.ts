...
RowImg.parameters = {
  ...
  docs: {
    source: {
      code: `
      <!-- Column contain isImg flag to true also Row contain image url -->
...
RowImgEmpty.parameters = {
  ...parameters,
  docs: {
    source: {
      code: `
      <!-- Column contain isImg flag to true but Row doesn't contain image url -->
      <app-grid-item [row]="row" [column]="column"></app-grid-item>
      `,
      language: 'html',
    },
...
RowFormat.parameters = {
  ...parameters,
  docs: {
    source: {
      code: `
      <!-- Column contain format fuction to parse data ex. format: (value: number): string => \`$\{value\}$\` -->
      <app-grid-item [row]="row" [column]="column"></app-grid-item>
      `,
      language: 'html',
    },
